...
# Streamlit App
def main():
    st.title("Plant Disease Detection Application")
    ...
    if uploaded_file is not None:
        try:
            ...
            # Load model
            model_path = r"C:\\Users\\gopir\\Desktop\\Plant_disease_detection\\Code\\cnn_model.pth"  # Ensure this path is correct relative to your Streamlit app
            ...
            if st.button("Predict Disease"):
                with st.spinner("Processing..."):
                    ...
                    st.success(
                        f"The leaf is predicted to have: **{predicted_class}** with a confidence of **{confidence:.2f}%**."
                    )
